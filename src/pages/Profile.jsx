  ...
  return (
    <>
      <header className="clear-both rounded-md bg-zinc-900 py-8 px-4 text-zinc-50">
        ...
        <button
          type="button"
          className="mt-4 ml-auto block w-fit rounded-md border-x border-y border-solid border-zinc-200 px-2 py-1 text-sm transition duration-200 ease-in-out  hover:-translate-y-1 hover:drop-shadow-md"
          onClick={onLogOut}
        >
          Log Out
        </button>

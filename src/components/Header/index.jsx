...
const DesktopNav = () => {
  return (
    <ul className="inline-flex items-center ">
      ...
      {/* {!isLoading && !user && ( */}
      <>
        <li className="mr-4 transform cursor-pointer rounded-md  border-x border-y border-solid border-slate-200 px-4 py-2 transition duration-200 ease-in-out hover:-translate-y-1 hover:drop-shadow-md">
          <Link href="/auth/signin" passHref>
            <a>Sign In</a>
          </Link>
        </li>
        <li className="transform cursor-pointer rounded-md border-x border-y border-solid border-slate-900 bg-slate-900 px-4 py-2 text-slate-50 transition duration-200 ease-in-out hover:-translate-y-1 hover:shadow-md">
